        ...
        while (api_call_count < self.max_iterations and self.iteration_budget.remaining > 0) or self._budget_grace_call:
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    _use_streaming = True
                    # Headless integrations like Paperclip can opt into the
                    # non-streaming path explicitly. This is important for
                    # providers whose streaming tool-call path is unreliable
                    # even though regular non-streaming chat completions work.
                    if is_truthy_value(os.getenv("HERMES_FORCE_NON_STREAMING")):
